...
public class LingPipeTwitter {
    ...
    public LingPipeTwitter(String[] args) {
        System.out.println("\nBASIC POLARITY DEMO");
    ...
    public void train2() throws IOException {
        int numTrainingCases = 0;
        int numTrainingChars = 0;
        System.out.println("\nTraining.");
    ...
    void createDataset(){
        ...
        try {
            ...
            String q="select distinct TEXT from TrainSetLingPipe";
            ArrayList<String> listtweets=new ArrayList<>();
            ResultSet rs = stmt.executeQuery(q);
            while(rs.next()){
                listtweets.add(rs.getString("TEXT").toString());
            }
            String query="select distinct * from TrainSetLingPipe";
    ...
    public static void main(String[] args) {
        ...
        /*
        try{
            new LingPipeTwitter(args).createDataset();
        } catch (Throwable t) {
            System.out.println("Thrown: " + t);
            t.printStackTrace(System.out);
        }*/
        ...
        try {
            ...
            int c=0;
            while (rs.next() && c<50002){
                c+=1;
                if (rs.getString("TWEET_ID").equals("1231147211708227586")){
            ...
            while (rs.next() && count2<2000000){
                if (rs.getString("TWEET_ID").equals("1241131534700216320")){
                    System.out.println(rs.getString("TWEET_ID"));
                    System.out.println("oi "+count2);
                    break;
            ...
            while (rs.next() && count<50000) {
                ...
                try {
                    ...
                    if (status == null) { // 
                        ...
                        String sql = "INSERT INTO TESTHIGHNEUTRALTWEET (TWEET_ID,USER_ID,NEUTRAL_PROBABILITY,TEXT,LABEL) "
